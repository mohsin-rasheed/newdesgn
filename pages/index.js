        ...
        <div id="productsSlider" className="carousel slide" data-bs-ride="carousel">
          <div className="carousel-inner">
            {products.map((product, index) => (
              <div className={`carousel-item ${index === 0 ? 'active' : ''}`} key={product.name}>
                <div className="product-focus text-center p-4">
                  <img src={product.image} alt={product.name} className="img-fluid product-image mb-4" />
                  <h3 className="h5 fw-bold text-uppercase mb-3">{product.name}</h3>
